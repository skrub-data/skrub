...
def get_ken_embeddings(types, exclude=None, pca_components=None, suffix=""):
    ...
    emb_full = pd.read_parquet("https://figshare.com/ndownloader/files/39142985")
    emb_type = pd.read_parquet("https://figshare.com/ndownloader/files/39143012")
