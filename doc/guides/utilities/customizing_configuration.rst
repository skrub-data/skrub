...
>>> config.keys()
dict_keys(['use_table_report_data_ops', 'table_report_verbosity', 'plots_threshold', 'associations_threshold', 'subsampling_seed', 'enable_subsampling', 'float_precision', 'cardinality_threshold', 'data_dir', 'eager_data_ops'])
