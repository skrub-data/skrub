...
# This script generates a .pyi (stub) file for skrub/_dataops/_dataops.py.
...
# would be to make sure no public functions are defined in _dataops.py,
...
# IT IS AUTOMATICALLY GENERATED BY /build_tools/generate_dataops_stub.py
