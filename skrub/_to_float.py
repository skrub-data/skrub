...
class ToFloat(SingleColumnTransformer):
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Could not convert column 'x' to numbers.
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Refusing to cast column 's' with dtype 'category' to numbers.
    >>> to_float.fit_transform(pd.to_datetime(pd.Series(['2024-05-13'], name='s')))
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Refusing to cast column 's' with dtype 'datetime64[...]' to numbers.
