...
def _raise_dispatch_unregistered_type(obj, kind="object"):
...
def dataframe_module_name(obj):
    ...
    _raise_dispatch_unregistered_type(obj)
...
@dispatch
def to_list(col):
    _raise_dispatch_unregistered_type(col, kind="Series")
...
@dispatch
def to_numpy(col):
    _raise_dispatch_unregistered_type(col, kind="object")
...
def concat(*dataframes, axis=0):
    ...
    _raise_dispatch_unregistered_type(dataframes[0])
...
@dispatch
def col(df, col_name):
    _raise_dispatch_unregistered_type(df, kind="DataFrame")
