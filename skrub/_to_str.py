...
class ToStr(SingleColumnTransformer):
    ...
    Traceback (most recent call last):
        ...
    skrub._apply_to_each_column.RejectColumn: Refusing to convert 's' with dtype 'float64' to strings.
    >>> to_str.fit_transform(pd.Series(['a', 'b'], name='s', dtype='category'))
    Traceback (most recent call last):
        ...
    skrub._apply_to_each_column.RejectColumn: Refusing to convert 's' with dtype 'category' to strings.
    >>> to_str.fit_transform(pd.to_datetime(pd.Series(['2020-02-02'])))
    Traceback (most recent call last):
        ...
    skrub._apply_to_each_column.RejectColumn: Refusing to convert None with dtype 'datetime64[...]' to strings.
    ...
    Traceback (most recent call last):
        ...
    skrub._apply_to_each_column.RejectColumn: Refusing to convert 's' with dtype 'Enum(categories=['a', 'b'])' to strings.
    >>> to_str.fit_transform(pl.Series('s', ['2020-02-01']).cast(pl.Date))
    Traceback (most recent call last):
        ...
    skrub._apply_to_each_column.RejectColumn: Refusing to convert 's' with dtype 'Date' to strings.
