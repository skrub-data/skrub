...
class SelectCols(TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=None):
        ...
        """
        self._columns_ = s.make_selector(self.cols).expand(X)
        return self
    ...
    def transform(self, X):
        ...
        """
        return s.select(X, self._columns_)
    ...
    def get_feature_names_out(self, input_features=None):
        ...
        """
        check_is_fitted(self, "_columns_")
...
class DropCols(TransformerMixin, BaseEstimator):
    ...
    def fit(self, X, y=None):
        ...
        self._kept_cols_ = (~selector).expand(X)
        self._dropped_cols_ = selector.expand(X)
        return self
    ...
    def transform(self, X):
        ...
        DataFrame
            ...
            ``self.cols``.
        """
        return s.select(X, s.make_selector(self._kept_cols_))
    ...
    def get_feature_names_out(self, input_features=None):
        ...
        feature_names_out : ndarray of str objects
            Transformed feature names.
        """
        check_is_fitted(self, "_kept_cols_")
        return self._kept_cols_
