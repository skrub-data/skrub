...
def graphviz_error_message(html=False):
    if html:
        return """\
To display the DataOp graph, please install pygraphviz and Graphviz
...
please install pygraphviz and Graphviz and make sure the 'dot' command is in your $PATH.
