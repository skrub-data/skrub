...
class CleanNullStrings(SingleColumnTransformer):
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Could not convert column 's' to numbers.
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Column 's' does not contain strings.
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Column None does not contain strings.
