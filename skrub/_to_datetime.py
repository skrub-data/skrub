...
class ToDatetime(SingleColumnTransformer):
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Failed to convert column 'when' to datetimes using the format '%d/%m/%Y'.
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Column 'year' does not contain strings.
    ...
    Traceback (most recent call last):
        ...
    skrub.core._single_column_transformer.RejectColumn: Could not find a datetime format for column 'when'.
