...
- Features generated by the :class:`StringEncoder` are now named with indices in the range ``[1, n_components]``, rather than
  ``[0, n_components -1]`` to be consistent with the other encoders. :pr:`1405` by :user:`Riccardo Cappuzzo<rcap107>`.
