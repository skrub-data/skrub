...
# and create a |pipeline| by appending a |HistGradientBoostingRegressor|, which
...
gap_results = cross_validate(gap_pipe, X, y, scoring="r2")
...
# |HistGradientBoostingRegressor|. To do this, we can simply replace
...
minhash_results = cross_validate(minhash_pipe, X, y, scoring="r2")
...
text_encoder_results = cross_validate(text_encoder_pipe, X, y, scoring="r2")
