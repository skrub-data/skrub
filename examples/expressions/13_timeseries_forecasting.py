...
In this example, we illustrate how to combine the datetime features generated by the
|DatetimeEncoder| with the skrub expressions to forecast the demand for bike
rentals over time.
