...
# %%
# As the "item" and "model" columns both expose typos and text similarities, we use a
# MinHashEncoder.
#
# "make" and "goods_code" on the other hand consist in orthogonal categories. We
# encode them using a OrdinalEncoder.
#
# Finally, we bring this logic into a TableVectorizer to encode these columns in a
# single step.
#
# See `here <https://skrub-data.org/stable/auto_examples/01_encodings.html#specializing-the-tablevectorizer-for-histgradientboosting>`_
# for more details about these choices.
...
# chaining two AggJoiners together:
#
