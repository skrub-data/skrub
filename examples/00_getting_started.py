...
# %%
# Explore all the available `datasets <https://skrub-data.org/stable/reference/downloading_a_dataset>`_.
...
# --------------------------------------------------------------
#
# The goal of ``skrub`` is to ease tabular data preparation for machine learning. The :func:`~skrub.tabular_learner`
# function provides an easy way to build a simple but reliable machine-learning model, working well on
#  most tabular data.
...
# ---------------
#
# ``Skrub`` allows imperfect assembly of data, in the case where columns are dirty and can contain typos.
#
# mThe :class:`~skrub.Joiner`
...
# %%
#  Information about capitals have been added for France and Italia, but not for Georgia since it's not
# present in the auxiliary table.
#
...
# %%
# Which correspond to the respective positions of Madrid and Rome in the initial column ! This column can now be understood
...
#
# Visit ourm `examples <https://skrub-data.org/stable/auto_examples>`_ for more illustrations of the tools offered by ``skrub``.
